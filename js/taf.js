...
function thousand(number) {
    ...
    return thousandsTrillions (thousands["1"],thousands["2"], thousands["39"], thousands["1"], 0, parseInt (number),  (getNthReverse (number, 4)));    
    } else {
...
function million(number) {
    ...
    return thousandsTrillions (millions["1"],millions["2"], millions["39"], millions["1"], 3, parseInt (number),  (getNthReverse (number, 7)));
    } else {
...
function billion(number) {
    ...
    return thousandsTrillions (billions["1"],billions["2"], billions["39"], billions["1"], 6, parseInt (number),  (getNthReverse (number, 10))); 
    } else {
